...
arrays = edges[["organisation_x"]] + edges[["organisation_y"]]

edges = edges.groupby(["organisation_x","organisation_y"]).aggregate({'ut': 'count'}).reset_index() # now count the unique number of UTs
